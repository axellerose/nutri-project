...
module.exports = hbs.registerHelper("ifHasAuth", function (
  v1,
  v2,
  v3,
  options
...
module.exports = hbs.registerHelper("ifNotContains", function (
  v1,
  v2,
  options
) {
...
module.exports = hbs.registerHelper("ifAndOperator", function (
  v1,
  v2,
  options
) {
...
module.exports = hbs.registerHelper("getAverageInPercent", function (
  v1,
  options
) {
